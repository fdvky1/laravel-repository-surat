                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group focused">
                                        ...
                                        <input type="text" id="letter_number" class="form-control" name="letter_number" value="{{ $letter->letter_number }}">
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group focused">
                                        <label class="form-control-label" for="from">From</label>
                                        <input type="text" name="from" id="from" class="form-control" value="{{ $letter->from }}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group focused">
                                        ...
                                        <input type="date" id="letter_date" class="form-control" name="letter_date" value="{{ date('Y-m-d', strtotime($letter->letter_date)) }}">                                    </div>
                                </div>
                                <div class="col-lg-6">
                                <div class="form-group focused">
                                    <label class="form-control-label" for="received_date">Received date<span class="small text-danger">*</span></label>
                                    <input type="date" id="received_date" class="form-control" name="received_date" value="{{ date('Y-m-d', strtotime($letter->received_date)) }}">
                                </div>
                                </div>
                            </div>
                            <div class="">
                                <div class="form-group focused">
                                    ...
                                    <textarea id="regarding" class="form-control" name="regarding">{{ $letter->regarding }}</textarea>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-4">
