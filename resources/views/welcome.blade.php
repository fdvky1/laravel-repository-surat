...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg bg-secondary fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand" href="#page-top">Sistem Repositori Persuratan</a>
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                ...
                <img class="masthead-avatar mb-5" src="https://icon-icons.com/icons2/517/PNG/512/letter_icon-icons.com_51108.png" alt="..." />
                <!-- Masthead Heading-->
                <h1 class="masthead-heading mb-0">Sistem Repositori <br/> Persuratan Berbasis Web</h1>
                <!-- Icon Divider-->
        ...
        <div class="copyright py-4 text-center text-white">
            <div class="container"><small>Copyright &copy; Alkademi 2023</small></div>
        </div>
